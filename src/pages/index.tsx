...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Book Story v1`}</title>

        <meta
          name="description"
          content="Welcome to Book Story v1, your ultimate SaaS platform, empowering book creators to bring their stories to life seamlessly and efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxib29rc3xlbnwwfHx8fDE2OTc4MTEzMzB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Book Story v1, your ultimate SaaS platform, empowering book creators to bring their stories to life seamlessly and efficiently.`}
            </Text>
            <Box
