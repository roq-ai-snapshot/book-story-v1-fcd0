  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['company', 'chapter.count', 'review.count', 'subscription.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['title.contains', 'author.contains', 'genre.contains'],
          ...params.filters,
        },
        'book',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'author', header: 'Author', accessorKey: 'author' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.publication_date ? format(record?.publication_date, 'dd-MM-yyyy') : '',
    },
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('chapter', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'chapter',
          header: 'Chapter',
          accessorKey: 'chapter',
          cell: ({ row: { original: record } }: any) => record?._count?.chapter,
        }
      : null,
