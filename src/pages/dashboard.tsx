...
import { useChapterCount, useBookCount, useReviewCount, useRoqPlatformUserProfiles } from 'lib/roq';
...
function DashboardPage() {
  ...
  const chapterStat = useChapterCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      title: 'Chapters',
      result: chapterStat?.data,
      isLoading: chapterStat.isLoading,
