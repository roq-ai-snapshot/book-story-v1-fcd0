...
export function useChapterFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useChapterFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chapter.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChapterCount<T extends Prisma.chapterCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.chapterCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useChapterCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chapter.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChapterFindManyWithCount<
  T extends Prisma.chapterFindManyArgs,
  R extends { data: GetFindResult<Prisma.$chapterPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.chapterFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useChapterFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chapter.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChapterFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useChapterFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chapter.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
